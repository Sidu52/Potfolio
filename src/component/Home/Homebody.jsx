...
import bg from '../../Image/home/bg-header-removebg-preview.png'
...
export default function Homebody() {
    ...
    const animations = {
        ...
        div: {
            initial: {
                opacity: 0,
                transition: { duration: 0.3, ease: "easeOut" }, // Updated transition property
            },
            whileInView: {
                opacity: 1,
                transition: { duration: 0.8, ease: "easeIn" }, // Updated transition property
            },
        },
    };
